...
{
    public partial class CommodityController : BaseAdminController
    {
        #region Fields
        ...
        public CommodityController(IAclService aclService,
        ...
        [HttpPost]
        public virtual IActionResult CommodityList(CommoditySearchModel searchModel)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageProducts))
                return AccessDeniedDataTablesJson();

            //prepare model
            var model = _commodityModelFactory.PrepareCommodityListModel(searchModel);
